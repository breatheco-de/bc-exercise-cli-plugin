...
bc-exercise-cli/0.0.25 linux-x64 node-v8.11.3
...
_See code: [src/commands/instructions.js](https://github.com/alesanchezr/bc-exercise-cli/blob/v0.0.25/src/commands/instructions.js)_
...
_See code: [src/commands/run-exercise.js](https://github.com/alesanchezr/bc-exercise-cli/blob/v0.0.25/src/commands/run-exercise.js)_
...
_See code: [src/commands/test-exercise.js](https://github.com/alesanchezr/bc-exercise-cli/blob/v0.0.25/src/commands/test-exercise.js)_
<!-- commandsstop -->
