...
bc-exercise-cli/0.7.02 linux-x64 node-v8.11.4
...
_See code: [src/commands/run/exercises.js](https://github.com/alesanchezr/bc-exercise-cli/blob/v0.7.02/src/commands/run/exercises.js)_
...
_See code: [src/commands/run/server.js](https://github.com/alesanchezr/bc-exercise-cli/blob/v0.7.02/src/commands/run/server.js)_
...
_See code: [src/commands/test/exercise.js](https://github.com/alesanchezr/bc-exercise-cli/blob/v0.7.02/src/commands/test/exercise.js)_
<!-- commandsstop -->
